...
public class SoundEnvironment extends InputComponent<VolumeAmplitudeState> {

    public SoundEnvironment(SimpleBuffer<VolumeAmplitudeState> inputBuffer, int SAMPLE_SIZE_IN_BITS, SampleRate sampleRate) {
        super(inputBuffer, InputComponent.toMethod(buildPipe(SAMPLE_SIZE_IN_BITS, sampleRate)));
    }
