...
public class BottomIncrementalChordGenerator extends IncrementalChordGenerator {
    ...
    public BottomIncrementalChordGenerator(BoundedBuffer<Buckets> harmonicsBuffer, int chordSize, Frequency centerFrequency, int totalMargin, int hardLeftBorder, int hardRightBorder, int repetitionDampener, SpectrumWindow spectrumWindow) {
